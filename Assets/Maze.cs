...
class Maze
{
	...
	public System.Random random = new System.Random((int)DateTime.Now.Ticks & (0x0000FFFF));
	...
	public Maze(int width, int length)
	{
		...
		this.width = (UInt16) (width/2);
		this.height = (UInt16) (length/2);

		maze = BuildBaseMaze();
		GenerateTWMaze_GrowingTree();
	}
	...
	public Byte[,] BuildBaseMaze()
	{
		Byte[,] maze = new Byte[this.width, this.height];
		return maze;
	}
